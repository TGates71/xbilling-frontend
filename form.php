      ...
      <div id="content">
        <form name="frm_order" id="frm_order" method="post">
          ...
          <div id="pkg_<?php echo($package['id']); ?>" class="package"> 
            ...
            <span class="package"><?php echo($package['name']); ?></span>
            ...
            <div id="select_pkg_<?php echo($package['id']); ?>" class="package_select" onclick="_select_pkg('<?php echo($package['id']); ?>');"> <img src="images/icon_ok.png" class="top" alt="select package" />select </div>
          ...
          <?php
                    ...
                    echo('<p>&nbsp;</p><div class="center" style="color: #f00;font-size:15px;">Sorry, we are not currently accepting new accounts.<br>Please check back later.</div>');
                  }
                break;
                //account info
                case 2:
